$(document).ready(function() {
    ...
    function sendRequest(endpoint, method, mydata, successCallback) {
        $.ajax({
            url: endpoint,
            method: method,
            data: mydata,
    ...
    function sendDataToServer(mydata) {
        sendRequest("/save/", "POST", mydata, handleSaveResponse);
    }
    
    function sendDeleteRequest(mydata, element) {
        sendRequest("/delete/", "POST", mydata, function (data) {
            handleDeleteResponse(data, element);
        });
    }
    
    function sendEditRequest(mydata) {
        sendRequest("/edit/", "POST", mydata, handleEditResponse);
    }
